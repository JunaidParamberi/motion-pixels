  ...
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="container mx-auto px-4 flex flex-col items-start justify-center h-full space-y-6 z-10 relative">
        <h1 className="text-white text-left font-extrabold uppercase z-20 text-4xl  sm:text-5xl md:text-6xl lg:text-7xl leading-tight">
          Immersive Design <br /> for the Future
        </h1>
        <button className="z-20 border border-white text-white px-6 py-2 uppercase font-semibold hover:bg-white hover:text-black transition">
          Explore Work
        </button>
      </div>
