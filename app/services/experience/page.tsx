...
import { experienceData } from "@/app/data/site-data";
...
const experienceCards = [
  ...
  },
  {
    ...
    description:
      "We bring ideas to motion, whether for product visualization, storytelling, or complex interactive experiences that captivate any audience.",
    icon: HiFilm,
    color: "pink",
  },
];
...
const ExperiencePage = () => {
  return (
    <MotionDiv
      className="relative min-h-screen overflow-x-hidden bg-[#0505058f] text-slate-100"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <header className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
        ...
        >
          <Image
            src={experienceBg}
            alt="Person floating in digital vortex with vibrant lights"
            fill
        ...
        >
          ...
          >
            Step into the future of digital storytelling where reality blends
          ...
          <aside className="lg:w-1/4">
            ...
            >
              ...
              <p className="text-slate-200 text-lg leading-relaxed font-light mb-6">
                ...
                , our Experience service brings imagination to life by blending
                technology with storytelling.
              </p>
              <p className="text-slate-300 text-sm  leading-relaxed mb-8">
                We specialize in creating immersive, interactive, and
                emotionally resonant environments using cutting-edge tools.
                Whether it&apos;s through AR, VR, or MR, we craft unforgettable
                digital experiences.
              </p>
