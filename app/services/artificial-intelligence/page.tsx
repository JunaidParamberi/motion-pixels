...
const aiCards = artificialIntelligenceData.items.map((item, i) => {
  const icons = [HiFilm, HiCollection, HiChip, HiViewGrid];
  const colors = ["primary", "secondary", "indigo", "purple"];
  return {
    ...item,
    icon: icons[i],
    color: colors[i],
    ...
    >
      ...
      <header className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20">
        ...
        >
          <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-[10px] font-bold tracking-[0.2em] uppercase">
            ...
            <span className="text-white">
              {artificialIntelligenceData.title}
            </span>
          </nav>
        </MotionDiv>
        <MotionDiv
        ...
        >
          ...
          >
            We combine advanced AI tools with creative artistry to transform
            imagination into cinematic reality—frame by frame.
          </MotionP>
          <MotionDiv
            variants={heroItem}
            transition={{ duration: 0.5, ease }}
          ...
          <aside className="lg:w-1/4">
            ...
            >
              ...
              <p className="text-slate-200 text-lg leading-relaxed font-light mb-6">
                ...
                , we combine advanced AI tools with creative artistry to help
                filmmakers and studios craft seamless, photorealistic visuals.
              </p>
              <p className="text-slate-300 text-sm leading-relaxed mb-8">
                Whether it&apos;s AI-assisted world-building, intelligent
                creature animation, or complex dynamic simulations, we transform
                imagination into cinematic reality—frame by frame.
              </p>
